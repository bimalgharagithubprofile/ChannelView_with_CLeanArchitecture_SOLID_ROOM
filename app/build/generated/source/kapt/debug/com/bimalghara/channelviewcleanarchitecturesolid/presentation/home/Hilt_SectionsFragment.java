 ...
 */
public abstract class Hilt_SectionsFragment<B extends ViewBinding> extends BaseFragment<B> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SectionsFragment_GeneratedInjector) this.generatedComponent()).injectSectionsFragment(UnsafeCasts.<HomeFragment>unsafeCast(this));
    }
  }
